...
app/
  ...
  execution/   # ExecutionEngine ABC + per-language engines (Python/Java/C++ implemented, Spring stubbed) + registry
...
content/
  ...
  # content/python/, content/java/, and content/cpp/ have real content; spring/ exists but is empty (.gitkeep)
